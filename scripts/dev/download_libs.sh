...
download(){
    ...
    echo wget https://github.com/openframeworks/apothecary/releases/download/nightly/$1 $SILENT_ARGS
    wget https://github.com/openframeworks/apothecary/releases/download/nightly/$1 
}
